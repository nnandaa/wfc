...
Neue", "Noto Sans", 
                "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe 
...
2.1.8/datatables.min.js"></script> 
    <script 
src="https://cdn.datatables.net/rowgroup/1.5.1/js/dataTables.rowGroup.js"></script> 
    <!-- Sweetalert2 --> 
                ...
                <div class="container-fluid"> 
                    <div class="row mb-2"> 
                        <div class="col-sm-6"> 
                            <h1 class="m-0"> 
                                <?= $contentPath ? 
htmlspecialchars(ucfirst($dashboard->getSubName())) : '' ?> 
                            </h1> 
                        </div> 
                        <div class="col-sm-6"> 
