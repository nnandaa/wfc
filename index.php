...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    if (isset($_POST['aksi']) && $_POST['aksi'] === 'addKeranjang') { 
        ...
        //jika terdapat error 
        if (!array_key_exists('icon', $result) && !array_key_exists('message', 
$result) && !empty($result)) { 
...
?> 
    ...
    <!-- Modal Structure --> 
    <div class="modal fade" id="produkModal" tabindex="-1" aria
labelledby="produkModalLabel" aria-hidden="true"> 
        <div class="modal-dialog modal-lg"> 
            <div class="modal-content"> 
                <div class="modal-header"> 
                    <h5 class="modal-title" id="produkModalLabel"><b>Detail 
Produk</b></h5> 
...
dismiss="modal" aria-label="Close"></button> 
                ...
                <div class="modal-body"> 
                    <div class="row"> 
                        <div class="col-md-6"> 
                            <img id="modal-product-photo" class="img-fluid" 
alt="Product Image"> 
                        </div> 
                        <div class="col-md-6"> 
                            <h2 id="modal-product-name" class="fw-bold fs
2"></h2> 
                            <span class="badge text-bg-primary" id="modal
product-category"></span> 
                            <p id="modal-product-description" class="lead"></p> 
                            <span class="text-body-secondary text-dark mt-3 fs-6" 
id="modal-product-stock"></span> 
                            <h2 class="text-success fs-2 fw-semibold" id="modal
product-price"></h2> 
                        </div> 
                    </div> 
                </div> 
...
block;" 
                                ...
                                <input type="hidden" name="id_produk" id="modal
product-id"> 
                                <input type="hidden" value="addKeranjang" 
name="aksi"> 
                                <div class="input-group mb-2 justify-content
center"> 
                                    <label for="jumlah" class="input-group-text 
text-body-secondary">Jumlah dipesan 
                                        :</label> 
                                    <input type="number" class="form-control" 
name="jumlah" id="jumlah" min="0" value="0" 
                                        required aria-describedby="button
addon2"> 
                                    <button class="btn btn-sm btn-success" 
type="submit" id="button-addon2"> 
                                        <i class="bi bi-cart-plus-fill me
1"></i>Keranjang 
                                    </button> 
                                </div> 
                            </form> 
...
description; 
            ...
            document.getElementById('modal-product-stock').textContent = `Stok 
Tersedia: ${stock}`; 
            document.getElementById('modal-product-price').textContent = `Rp. 
${price}`; 
