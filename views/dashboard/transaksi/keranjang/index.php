        ...
        <div class="card-body table-responsive p-4"> 
            <table id="table" class="table mt-2"> 
                ...
                <tbody> 
                    ...
                    foreach ($data as $k) { ?> 
                        <tr> 
                            <td class="font-weight-bold"><mark><?= 
$k['nama_produk']; ?></mark></td> 
                            <td><img src="<?= $k['photo']; ?>" alt="foto <?= 
$k['nama_produk']; ?>" class="img-fluid" 
                                    style="max-width: 100px"> 
                            </td> 
                            <td><?= $k['jumlah']; ?></td> 
                            <td><?= number_format($k['harga_satuan'], 0, ',', 
'.'); ?></td> 
                            <td><?= number_format($k['jumlah'] * 
$k['harga_satuan'], 0, ',', '.'); ?> 
