...
<div class="col-lg-12"> 
    ...
    <div class="card card-warning"> 
        <div class="card-header"> 
            <h3 class="card-title">Ubah Pelanggan <b><?= $pelanggan['nama'] 
?></b></h3> 
        </div> 
...
name="telp" 
                        ...
                        <?php if (isset($errors['telp'])): ?> 
                            <div class="invalid-feedback"><?= $errors['telp'] 
?></div> 
                        <?php endif; ?> 
                    </div> 
                </div> 
...
isset($errors['alamat']) ? 'is-invalid' : '' ?>" id="alamat" 
                        name="alamat" rows="3"><?= $pelanggan['alamat'] 
?></textarea> 
                    <?php if (isset($errors['deskripsi'])): ?> 
                        <div class="invalid-feedback"><?= $errors['alamat'] 
?></div> 
                    <?php endif; ?> 
                </div> 
            </div> 
