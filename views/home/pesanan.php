            ...
            <div class="card"> 
                <div class="card-header"> 
                    <h3 class="d-flex card-title align-items-center fw-bold"> 
                        <i class="bi bi-cart-fill me-1 bg-success rounded text-white 
p-1"></i>Riwayat Pesanan 
                    </h3> 
                </div> 
                <!-- /.card-header --> 
                        ...
                        <tbody> 
                            ...
                            foreach ($data as $pesanan) { 
                                ...
                                <tr data-id="<?= $pesanan['id']; ?>"> 
                                    ...
                                    <td><?= number_format($pesanan['total'], 0, ',', 
'.'); ?></td> 
                                    <td><?= $pesanan['status']; ?></td> 
                                </tr> 
 
                                <!-- Pass the product details for each order as a 
JavaScript variable --> 
                                <script> 
                                    var details_<?= $pesanan['id']; ?> = <?php echo 
json_encode($detailPesanan); ?>; 
                                </script> 
                            <?php } ?> 
                        </tbody> 
                    </table> 
