            ...
            <div class="card"> 
                <div class="card-header"> 
                    <h3 class="d-flex card-title align-items-center fw-bold"><i 
                            class="bi bi-bag-heart-fill me-1 bg-danger rounded text
white p-1"></i>Keranjang Anda</a> 
                    </h3> 
                </div> 
                <!-- /.card-header --> 
                        ...
                        <tbody> 
                            ...
                            foreach ($data as $keranjang) { ?> 
                                <tr> 
                                    ...
                                    <td><img src="<?= $keranjang['photo']; ?>" 
alt="foto <?= $keranjang['nama_produk']; ?>" 
                                            class="img-fluid" style="max-width: 
100px"> 
                                    </td> 
                                    <td><input type="number" name="jumlah" min="0" 
value="<?= $keranjang['jumlah']; ?>" 
                                            style="width:70px; text-align:center"></td> 
                                    <td><?= 
number_format($keranjang['harga_satuan'], 0, ',', '.'); ?></td> 
                                    <td><?= number_format($keranjang['jumlah'] * 
$keranjang['harga_satuan'], 0, ',', '.'); ?> 
                                    </td> 
                                    <td> 
                                        <!-- Tombol Delete --> 
...
btn-danger">Hapus</button> 
                                ...
                                <?php 
                                $grandTotal += $keranjang['jumlah'] * 
$keranjang['harga_satuan']; 
                            } ?> 
                        </tbody> 
                        <tfoot> 
