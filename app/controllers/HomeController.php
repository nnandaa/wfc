...
class HomeController
{
    ...
    {
        // Jika menu adalah 'pembayaran', arahkan ke path pembayaran admin
        if ($this->menu === 'pembayaran') {
            $path = "./views/dashboard/pembayaran/index.php";
        } 
        // Jika menu adalah 'home', arahkan ke path default home
        elseif ($this->menu === 'home') {
            $path = "./views/home/index.php";
        } 
        // Jika menu lainnya, arahkan ke path menu terkait
        else {
            $path = "./views/home/{$this->menu}.php";
        }
    
        // Periksa validitas path sebelum mengembalikan
