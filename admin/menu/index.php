                    ...
                    <div class="row"> <!--begin::Col-->
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Menu WFC</h3>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $menu['stok'] ?></td>
                                                <td><a href="edit.php?id=<?= $menu['id_menu'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a class="btn btn-sm btn-danger"
                                                        href="?id=<?= $menu['id_menu'] ?>&aksi=hapus">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
